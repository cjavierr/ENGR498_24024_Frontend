  ...
  return (
    <div className="project-view-container">
      ...
      <Descriptions title="Project Details" bordered>
        <Descriptions.Item label="Project ID">{project.projectID}</Descriptions.Item>
        <Descriptions.Item label="Owner">{project.projectOwner}</Descriptions.Item>
        <Descriptions.Item label="Description">{project.projectDescription}</Descriptions.Item>
